            ...
            steps{
               ...
               //    withSonarQubeEnv(installationName: 'sonarqube') {
                 ...
                 //   sh 'mvn clean package sonar:sonar'
                    sh 'mvn clean  sonar:sonar -Dcheckstyle.skip -Dsonar.projectKey=groupId:artifactId -Dsonar.host.url=http://34.134.247.195/:9000 -Dsonar.login=loginHASH  -Dsonar.sources=src/main/java/ -Dsonar.java.binaries=target/classes'
